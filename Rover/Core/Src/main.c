...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, DIR_FL_Pin|DIR_ML_Pin|DIR_BL_Pin|DIR_FR_Pin
                          |DIR_MR_Pin|DIR_BR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIR_FL_Pin DIR_ML_Pin DIR_BL_Pin DIR_FR_Pin
                           DIR_MR_Pin DIR_BR_Pin */
  GPIO_InitStruct.Pin = DIR_FL_Pin|DIR_ML_Pin|DIR_BL_Pin|DIR_FR_Pin
                          |DIR_MR_Pin|DIR_BR_Pin;
